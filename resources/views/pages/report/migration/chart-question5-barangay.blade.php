<div class="card">
    <div class="card-body p-3">
        <div class="row d-flex justify-content-center">
            <div class="col-md-12">
                <canvas id="MigrationReportQuestion5ByBarangay" class="img-fluid"></canvas>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    var data = @json($MigrationReportQuestion5ByBarangay);
    var MigrationReportQuestion5ByBarangay = document.getElementById('MigrationReportQuestion5ByBarangay').getContext('2d');
    data.sort((a, b) => customBarangayOrder[a.barangay].localeCompare(customBarangayOrder[b.barangay]));

    var chart = new Chart(MigrationReportQuestion5ByBarangay, {
        type: 'bar',
        data: {
